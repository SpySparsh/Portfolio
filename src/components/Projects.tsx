...
// Simple Button component defined locally to prevent import errors
const Button = ({ children, className = "", variant, ...props }) => {
  return (
    <button 
      className={`inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none disabled:opacity-50 disabled:pointer-events-none h-9 px-4 py-2 ${className}`} 
      {...props}
    >
      {children}
    </button>
